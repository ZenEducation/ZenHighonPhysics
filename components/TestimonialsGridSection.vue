<template>
    <div class="body bg-indigo-100">
         <div class="w-full h-screen">
             ...
             >
                 <!--  color violet -->
                 <div
                     class="bg-primary-color-violet lg:order-1 lg:row-span-1 2xl:row-span-1 lg:col-span-2 rounded-lg shadow-xl mb-5 lg:mb-0"
                 >
                     <div class="mx-6 my-8 2xl:mx-10">
                         <img
                             class="w-8 md:w-9 2xl:w-20 h-8 md:h-9 2xl:h-20 rounded-full border-2 ml-1 lg:ml-3 2xl:ml-0 md:-mt-1 2xl:-mt-4"
                             src="../assets/TestimonialImages/Image-daniel.jpg"
                         />
                         <h1
                             class="text-white text-xs md:text-base 2xl:text-2xl pl-12 lg:pl-16 2xl:pl-20 -mt-8 md:-mt-10 2xl:-mt-20 2xl:mx-8"
                         >
                             Daniel Clifford
                         </h1>
                         <h2
                     ...
                     <img
                         class="absolute pt-3 top-1 left-24 md:left-64 2xl:left-96 pl-28 w-40 md:w-52 lg:w-auto 2xl:w-80 2xl:mx-10"
                         src="../assets/TestimonialImages/Bg-pattern-quotation.svg"
                     />
                     <div class="-mt-6 relative">
                         <p
                             class="text-white text-xl 2xl:text-4xl font-bold px-7 lg:px-9 2xl:pt-6 2xl:mx-2"
                         >
                 ...
                 <!--  componente de color gray-blue -->
                 <div
                     class="bg-primary-color-grayish-blue lg:order-2 lg:row-span-1 2xl:row-span-1 lg:col-span-1 rounded-lg shadow-xl pb-4 mb-5 lg:mb-0"
                 >
                     <div class="mx-8 2xl:mx-10 my-10">
                         <img
                             class="w-8 md:w-9 2xl:w-20 h-8 md:h-9 2xl:h-20 rounded-full border-2 -ml-1 -mt-2 lg:-mt-4"
                             src="../assets/TestimonialImages/Image-jonathan.jpg"
                         />
                         <h1
                 ...
                 <!--  componente gray-blue -->
 
                 <!-- componente de color white -->
                 <div
                 ...
                 >
                     <div class="mx-8 my-10 lg:my-8">
                         <img
                             class="w-8 md:w-9 2xl:w-20 h-8 md:h-9 2xl:h-20 rounded-full border-2 -mt-3 -ml-1 lg:-ml-0"
                             src="../assets/TestimonialImages/Image-jeanette.jpg"
                         />
                         <h1
                 ...
                 <!--  componente de color blackish-blue -->
                 <div
                     class="bg-primary-color-blackish-blue lg:order-4 lg:row-span-2 2xl:row-span-1 col-span-2 rounded-lg shadow-xl mb-5 lg:mb-0 2xl:mb-8 lg:pb-14 2xl:pb-20"
                 >
                     <div class="mx-8 my-8">
                         <img
                             class="w-8 md:w-9 2xl:w-20 h-8 md:h-9 2xl:h-20 rounded-full border-2 lg:-mt-3"
                             src="../assets/TestimonialImages/Image-patrick.jpg"
                         />
                         <h1
                             class="text-white text-xs md:text-base 2xl:text-2xl pl-12 md:pl-14 2xl:pl-24 -mt-8 md:-mt-10 2xl:-mt-16"
                         >
                             Patrick Abrams
                         </h1>
                         <h2
                     ...
                     <div class="px-3 -mt-3 mb-5 lg:mb-0">
                         <p
                             class="text-white text-lg 2xl:text-4xl font-semibold px-4 -mt-3 lg:-mt-6 2xl:mt-8"
                         >
                 ...
                 <!-- componente de color white -->
                 <div
                     class="bg-primary-color-white lg:order-2 lg:row-span-4 lg:col-span-1 rounded-lg shadow-xl mb-5 lg:mb-4 2xl:h-screen"
                 >
                     <div class="mx-8 my-8 lg:pl-1">
                         <img
                             class="w-8 md:w-9 2xl:w-20 h-8 md:h-9 2xl:h-20 rounded-full border-2 lg:-mt-3 -ml-1 lg:-ml-0"
                             src="../assets/TestimonialImages/Image-kira.jpg"
                         />
                         <h1
                             class="primary-color-blackish-blue text-xs md:text-base 2xl:text-2xl pl-10 md:pl-12 2xl:pl-24 -mt-8 md:-mt-10 2xl:-mt-16"
                         >
                             Kira Whittle
                         </h1>
                         <h2
                     ...
                     <div class="px-3 lg:px-5 lg:-mt-4 mb-5 lg:mb-0">
                         <p
                             class="primary-color-blackish-blue text-xl 2xl:text-4xl font-semibold px-4 lg:px-5 -mt-2 lg:-mt-0"
                         >
                             Such a life-changing experience. Highly recommended!
                         </p>
                         <br />
                         <p
                             class="primary-color-blackish-blue-opacity font-medium 2xl:text-3xl px-4 lg:px-5 2xl:px-4 lg:pr-8 mt-2 lg:-mt-1 2xl:mt-2 2xl:pb-64"
                         >
 ...
 .bg-primary-color-violet {
     background: hsl(263, 55%, 52%);
 }
 .bg-primary-color-grayish-blue {
     background: hsl(217, 19%, 35%);
 }
 .bg-primary-color-blackish-blue {
