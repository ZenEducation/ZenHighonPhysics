                ...
                <tr v-for="data in datasets" :key="data.id" class="border-b border-gray-200">
                  ...
                  <td class="py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      <font-awesome-icon v-if="data.increase" icon="fa-solid fa-plus" class="text-emerald-500"  />
                      <font-awesome-icon v-else icon="fa-solid fa-minus" class="text-red-500"  />
