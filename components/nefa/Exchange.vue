    ...
    <div class="flex items-center space-x-4">
      ...
      <div class="relative w-full max-w-[106px] sm:max-w-[159px]">
        <button
          ...
          @blur="toggleDropdown"
        >
          <img :src="`_nuxt/assets/img/${exchangeSelected.img}`" alt="" class="flex-shrink-0 h-6 w-6 rounded-full" />
          ...
          >
            ...
            >
              <div class="flex items-center">
                <img :src="`_nuxt/assets/img/${exchange.img}`" alt="" class="flex-shrink-0 h-6 w-6 rounded-full" />
