    ...
    <div class="w-full border-y border-[#DDDDDD]">
      <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        ...
        >
          ...
          <ul class="space-y-4">
            <nefaNavLink name="Cryptocurrency" url="#" />
            <nefaNavLink name="Exchanges" url="#" />
            <nefaNavLink name="Watchlist" url="#" />
            <nefaNavLink name="Portfolio" url="#" />
            <nefaNavLink name="NFT" url="#" />
          </ul>
        </div>
        <div
        ...
        >
          <ul class="space-y-4">
            <nefaNavLink name="Products" url="#" />
            <nefaNavLink name="About Us" url="#" />
            <nefaNavLink name="Careers" url="#" />
            <nefaNavLink name="Blog" url="#" />
            <nefaNavLink name="Security" url="#" />
          </ul>
        </div>
        <div
        ...
        >
          <ul class="space-y-4">
            <nefaNavLink name="Help Center" url="#" />
            <nefaNavLink name="Contact Us" url="#" />
            <nefaNavLink name="System Status" url="#" />
            <nefaNavLink name="Area of Avaibility" url="#" />
            <nefaNavLink name="Privacy Policy" url="#" />
          </ul>
        </div>
        <div
        ...
        >
          ...
          <div class="flex items-center space-x-2">
            ...
            />
            <button class="bg-blue-gradient px-4 py-4 sm:py-3 rounded-md hover:shadow-md transition duration-300">
            <font-awesome-icon icon="fa-solid fa-arrow-right" color="black"/>
            </button>
          </div>
        </div>
      </div>
