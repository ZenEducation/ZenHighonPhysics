<template>
  ...
  <div class="overflow-hidden">
    ...
       
    <section
      class="h-screen flex justify-center items-center flex-col bg-cyan-500"
    >
           
    ...
       
    <section
      class="h-screen flex justify-center items-center flex-col bg-cyan-400"
    >
           
    ...
       
    <section
      class="h-screen flex justify-center items-center flex-col bg-cyan-300"
    >
           
    ...
       
    <section
      class="h-screen flex justify-center items-center flex-col bg-cyan-200"
    >
           
