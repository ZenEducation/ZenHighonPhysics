<template>
        ...
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          >
            ...
            >
              ...
              <font-awesome-icon class="mt-1 text-[#0c66ee]" icon="fa-solid fa-chevron-down"/>
    ...
    <section class="w-full my-24">
      <nefaSection>
        <nefaBuyTradeImage class="sm:hidden mb-8" />
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 mt-4 xl:mt-20 space-y-6 px-4">
          ...
          <div class="space-y-6 lg:pr-12">
            ...
            />
            <nefaButton class="w-full px-5 py-4 bg-blue-gradient text-white text-base font-medium">Buy Now</nefaButton>
          </div>
        </div>
        <nefaBuyTradeImage data-aos="fade-left" class="hidden sm:block" />
      </nefaSection>
    </section>
    ...
    <section class="w-full my-36">
      <nefaSection data-aos="fade-down">
        ...
        <div class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20">
          ...
          <ul class="space-y-4 sm:space-y-2">
            <nefaListItem title="Up to 3% back on purchases" />
            <nefaListItem title="Earn rewards in bitcoin or any crypto on NEFA" />
            <nefaListItem title="No annual fee" />
          </ul>
          <nefaButton
     ...
     <section class="bg-trading-tools relative max-w-full sm:mx-4 my-20 py-16 shadow rounded-2xl overflow-hidden">
      <div class="relative max-w-screen-xl px-4 sm:px-2 mx-auto grid grid-cols-12 gap-x-6">
        <nefaTradingToolImage class="sm:hidden" />
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 space-y-8 sm:space-y-6 px-4 sm:px-6 mt-8">
          ...
          <div class="flex flex-col sm:flex-row">
            <nefaButton class="px-10 py-4 bg-inherit text-gradient border border-[#4A8FF6] text-base">
              Get Started
            </nefaButton>
            <nefaButton class="bg-inherit text-[#4A8FF6] px-10 py-4 text-center underline rounded-full">
              Learn More
            </nefaButton>
          </div>
        </div>
        <nefaTradingToolImage data-aos="fade-left" class="hidden sm:block" />
      </div>
    </section>
      ...
      <div class="relative max-w-screen-xl px-8 mx-auto grid grid-cols-12 gap-x-6">
        ...
        <div data-aos="fade-left" class="col-span-12 lg:col-span-5 space-y-8 sm:space-y-6 mt-8 xl:px-8">
          ...
          <ul class="space-y-8 sm:space-y-4">
            <nefaListItem title="Safety, security and compliance">
    ...
    <section class="bg-trading-tools relative max-w-full sm:mx-4 xl:mx-10 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full py-16 flex flex-col items-center">
        ...
        >
          <nefaStep v-for="step in steps" :key="step.title" :step="step" />
          <img
    ...
    <section class="w-full my-24">
          <nefaSection>
            ...
            <div data-aos="fade-left" data-aos-delay="150" class="col-span-12 lg:col-span-6 px-4 sm:px-6 mt-8">
              ...
              <ul class="shadow-box">
                <nefaAccordion v-for="(accordion, index) in accordions" :key="index" :accordion="accordion" />
              </ul>
            </div>
          </nefaSection>
    </section>
